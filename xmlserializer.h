...
{
    Rect Deserialize(const wxXmlNode* node)
    {
...
struct XmlSerializer
{
    ...
    wxXmlDocument SerializeGraphicMIDIObjects(const std::vector<GraphicMIDIEvent>& objects)
    {
        wxXmlDocument doc;
        ...
        {
            //std::visit(visitor, obj.rect); might not need this? idk
    ...
    std::vector<GraphicMIDIEvent> DeserializeGraphicMIDIObjects(const wxXmlDocument& doc)
    {
        wxXmlNode* root = doc.GetRoot();

        std::vector<GraphicMIDIEvent> objects;
